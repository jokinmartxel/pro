...
if (mysqli_num_rows($res) > 0) {
	...
	while ($row = mysqli_fetch_assoc($res)){ 
		   echo "<tr><td>" . $row["Id"]. "</td><td>" . $row["Email"]. "</td><td>" . $row["Galdera"]. "</td><td>" . $row["Zuzena"]. " </td><td>" . $row["Okerra1"]. "</td><td> " . $row["Okerra2"]. "</td><td>" . $row["Okerra3"]. "</td><td>" . $row["Zailtasuna"]. "</td><td>" . $row["Gaia"]. "</td><td> <img width='75' height='75' src='" . $row["Irudia"] . "'/> </td></tr> \n"; 
	}
}
